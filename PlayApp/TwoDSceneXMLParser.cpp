...
ParticleSimulation& TwoDSceneXMLParser::loadExecutableSimulation(
    const std::string& file_name, 
    scalar& dt,
    scalar& max_time)/*, scalar& steps_per_sec_cap,
 ...
 /*   return loadParticleSimulation(dt, node);
...
{*/
    ...
    return *(new ParticleSimulation(scene, scene_stepper));
};
